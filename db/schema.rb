...
ActiveRecord::Schema.define(version: 2018_11_22_012604) do
  ...
  create_table "comments_hashtags", force: :cascade do |t|
    t.integer "comment_id"
  ...
  create_table "went_prefectures", force: :cascade do |t|
    t.integer "went_id"
    t.integer "place_id"
    t.integer "prefecture_id"
    t.string "address"
